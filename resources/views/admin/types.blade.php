...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ $data['title'] or 'Types' }}</h1>
            <a href="#" class="btn btn-success add_btn"><i class="fa fa-plus"></i> Add Type</a>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            ...
            <!-- /.panel-heading -->
                <div class="panel-body">
                    @if($data['types'] && count($data['types']) > 0)
                        <table width="100%" class="table table-striped table-bordered table-hover" id="types-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                    ...
                    @else
                        <span>You don't have added types yet...</span>
                        <!-- /.table-responsive -->
                    @endif
                </div>
                <!-- /.panel-body -->
