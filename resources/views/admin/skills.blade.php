...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ $data['title'] or 'Skills' }}</h1>
            <a href="#" class="btn btn-success add_btn"><i class="fa fa-plus"></i> Add Skill</a>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <!-- /.panel-heading -->
                <div class="panel-body">
                    @if($data['skills'] && count($data['skills']) > 0)
                        <table width="100%" class="table table-striped table-bordered table-hover" id="skills-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                            ...
                            <tbody>
                            @foreach($data['skills'] as $s=>$skill)
                    ...
                    @else
                        <span>You don't have added skills yet...</span>
                        <!-- /.table-responsive -->
                    @endif
                </div>
                <!-- /.panel-body -->
