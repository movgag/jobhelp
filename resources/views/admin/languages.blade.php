...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ $data['title'] or 'Languages' }}</h1>
            <a href="#" class="btn btn-success add_btn"><i class="fa fa-plus"></i> Add Language</a>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <!-- /.panel-heading -->
                <div class="panel-body">
                    @if($data['languages'] && count($data['languages']) > 0)
                        <table width="100%" class="table table-striped table-bordered table-hover" id="languages-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                            ...
                            <tbody>
                            @foreach($data['languages'] as $l=>$language)
                    ...
                    @else
                        <span>You don't have added languages yet...</span>
                        <!-- /.table-responsive -->
                    @endif
                </div>
                <!-- /.panel-body -->
