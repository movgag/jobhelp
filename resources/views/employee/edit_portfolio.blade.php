...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">{{ $data['title'] or 'Edit Portfolio' }}</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form method="post" action="{{ url('/employee/edit-portfolio/'.$data['portfolio']->id) }}" role="form" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Title: </label>
                                    @php ($title = old('title')? old('title'): ($data['portfolio']->title ? $data['portfolio']->title : '' ) )
                                ...
                                <div class="form-group">
                                    ...
                                    @php ($description = old('description')? old('description'): ($data['portfolio']->description ? $data['portfolio']->description : '' ) )
                                ...
                                <div class="form-group">
                                    ...
                                    @php($portfolio_image = $data['portfolio']->image ? $data['portfolio']->image : 'no_portfolio.png')
                                    <img width="100px" height="100px" src="{{ asset('/images/emp-portfolios/'.$portfolio_image) }}" alt="">
                                    <input type="hidden" name="old_image" value="{{$data['portfolio']->image}}">
                                </div>
                            </div>
