...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'unverify' => \App\Http\Middleware\Verification::class,
        'unverifycompany' => \App\Http\Middleware\VerificationCompany::class,
        'verify_from_admin' => \App\Http\Middleware\CheckAdminVerifyForCompany::class,
    ];
}
